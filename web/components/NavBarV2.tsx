...
export default function NavBarV2() {
  return (
    <header className="sticky top-0 z-40 w-full border-b border-black/10 dark:border-white/15 bg-emerald-50 dark:bg-emerald-900/20">
      {/* Barre supérieure */}
      <div className="max-w-5xl mx-auto px-3 py-3 sm:p-4 flex items-center gap-3">
        {/* Logo */}
        ...
        {/* Droite: switcher langue, statut auth, menu mobile */}
